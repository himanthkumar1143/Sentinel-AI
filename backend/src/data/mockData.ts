import { IndustrialScenarioPayload, ScenarioType, ScenarioInfo } from '../types/industrial';
...
export const SCENARIOS_DATA: Record<ScenarioType, IndustrialScenarioPayload> = {
  normal: {
