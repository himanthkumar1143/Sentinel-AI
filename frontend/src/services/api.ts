import type { IndustrialScenarioPayload, ScenarioType, ScenarioInfo } from '../types/industrial';

const API_BASE_URL = import.meta.env.VITE_API_URL || 'http://localhost:5001/api';

export const SCENARIO_INFOS: Record<ScenarioType, ScenarioInfo> = {
  normal: {
    id: 'normal',
...
export const FALLBACK_SCENARIOS: Record<ScenarioType, IndustrialScenarioPayload> = {
  normal: {
    scenario: SCENARIO_INFOS.normal,
    overview: {
  ...
  warning: {
    scenario: SCENARIO_INFOS.warning,
    overview: {
  ...
  critical: {
    scenario: SCENARIO_INFOS.critical,
    overview: {
